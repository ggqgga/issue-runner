...
| `MAX_TIMEBOX_GRACE` | `3` | 한 claim 안에서 허용하는 연속 유예 횟수 — 완화가 무한 유예가 되지 않게 하는 상한. 15분 틱 기준 실제 상한은 ~1시간 45분. 상태 파일이 아니라 append 전용 이슈 코멘트 마커로 센다 |
