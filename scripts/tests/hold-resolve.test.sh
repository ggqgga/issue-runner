...
stale_f_newer_head_noone|H,F|H|1|-|agent-ready|late|ambiguous|3s
stale_f_newer_head_lane|H,F|H|1|-|agent:claimed|late|active|3s2
resolved_head_lookup_fail|H,F|H|1|-|agent-ready|none|blocked|3n
